...
static const sockopt_t sockopts[] = {
   ...
   { 46, int_val, IPV6_DONTFRAG, SOCKS_IPV6_DONTFRAG_LVL, SOCKS_IPV6_DONTFRAG_IPV4, SOCKS_IPV6_DONTFRAG_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_DONTFRAG_NAME },
   ...
   { 61, int_val, IPV6_PATHMTU, SOCKS_IPV6_PATHMTU_LVL, SOCKS_IPV6_PATHMTU_IPV4, SOCKS_IPV6_PATHMTU_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_PATHMTU_NAME },
   { 62, int_val, IPV6_PKTINFO, SOCKS_IPV6_PKTINFO_LVL, SOCKS_IPV6_PKTINFO_IPV4, SOCKS_IPV6_PKTINFO_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_PKTINFO_NAME },
   { 63, int_val, IPV6_ROUTER_ALERT, SOCKS_IPV6_ROUTER_ALERT_LVL, SOCKS_IPV6_ROUTER_ALERT_IPV4, SOCKS_IPV6_ROUTER_ALERT_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_ROUTER_ALERT_NAME },
   { 64, int_val, IPV6_RTHDR, SOCKS_IPV6_RTHDR_LVL, SOCKS_IPV6_RTHDR_IPV4, SOCKS_IPV6_RTHDR_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_RTHDR_NAME },
   { 65, int_val, IPV6_RTHDRDSTOPTS, SOCKS_IPV6_RTHDRDSTOPTS_LVL, SOCKS_IPV6_RTHDRDSTOPTS_IPV4, SOCKS_IPV6_RTHDRDSTOPTS_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_RTHDRDSTOPTS_NAME },
   { 66, int_val, IPV6_TCLASS, SOCKS_IPV6_TCLASS_LVL, SOCKS_IPV6_TCLASS_IPV4, SOCKS_IPV6_TCLASS_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_TCLASS_NAME },
   { 67, int_val, IPV6_UNICAST_HOPS, SOCKS_IPV6_UNICAST_HOPS_LVL, SOCKS_IPV6_UNICAST_HOPS_IPV4, SOCKS_IPV6_UNICAST_HOPS_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_UNICAST_HOPS_NAME },
   { 68, int_val, IPV6_V6ONLY, SOCKS_IPV6_V6ONLY_LVL, SOCKS_IPV6_V6ONLY_IPV4, SOCKS_IPV6_V6ONLY_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_V6ONLY_NAME },
   { 69, int_val, IPV6_XFRM_POLICY, SOCKS_IPV6_XFRM_POLICY_LVL, SOCKS_IPV6_XFRM_POLICY_IPV4, SOCKS_IPV6_XFRM_POLICY_IPV6, preonly, 0, 0, 0, 0, SOCKS_IPV6_XFRM_POLICY_NAME },
   { 70, int_val, SO_ERROR, SOCKS_SO_ERROR_LVL, SOCKS_SO_ERROR_IPV4, SOCKS_SO_ERROR_IPV6, invalid, 0, 0, 0, 0, SOCKS_SO_ERROR_NAME },
   { 71, int_val, SO_REUSEADDR, SOCKS_SO_REUSEADDR_LVL, SOCKS_SO_REUSEADDR_IPV4, SOCKS_SO_REUSEADDR_IPV6, invalid, 0, 0, 0, 0, SOCKS_SO_REUSEADDR_NAME },
   { 72, int_val, SO_REUSEPORT, SOCKS_SO_REUSEPORT_LVL, SOCKS_SO_REUSEPORT_IPV4, SOCKS_SO_REUSEPORT_IPV6, invalid, 0, 0, 0, 0, SOCKS_SO_REUSEPORT_NAME },
   { 73, int_val, SO_ACCEPTCONN, SOCKS_SO_ACCEPTCONN_LVL, SOCKS_SO_ACCEPTCONN_IPV4, SOCKS_SO_ACCEPTCONN_IPV6, invalid, 0, 0, 0, 0, SOCKS_SO_ACCEPTCONN_NAME },
   { 74, int_val, SO_TYPE, SOCKS_SO_TYPE_LVL, SOCKS_SO_TYPE_IPV4, SOCKS_SO_TYPE_IPV6, invalid, 0, 0, 0, 0, SOCKS_SO_TYPE_NAME },
   { 75, int_val, IP_ADD_MEMBERSHIP, SOCKS_IP_ADD_MEMBERSHIP_LVL, SOCKS_IP_ADD_MEMBERSHIP_IPV4, SOCKS_IP_ADD_MEMBERSHIP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_ADD_MEMBERSHIP_NAME },
   { 76, int_val, IP_ADD_SOURCE_MEMBERSHIP, SOCKS_IP_ADD_SOURCE_MEMBERSHIP_LVL, SOCKS_IP_ADD_SOURCE_MEMBERSHIP_IPV4, SOCKS_IP_ADD_SOURCE_MEMBERSHIP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_ADD_SOURCE_MEMBERSHIP_NAME },
   { 77, int_val, IP_BLOCK_SOURCE, SOCKS_IP_BLOCK_SOURCE_LVL, SOCKS_IP_BLOCK_SOURCE_IPV4, SOCKS_IP_BLOCK_SOURCE_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_BLOCK_SOURCE_NAME },
   ...
   { 79, int_val, IP_DROP_MEMBERSHIP, SOCKS_IP_DROP_MEMBERSHIP_LVL, SOCKS_IP_DROP_MEMBERSHIP_IPV4, SOCKS_IP_DROP_MEMBERSHIP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_DROP_MEMBERSHIP_NAME },
   ...
   { 81, int_val, IP_DROP_SOURCE_MEMBERSHIP, SOCKS_IP_DROP_SOURCE_MEMBERSHIP_LVL, SOCKS_IP_DROP_SOURCE_MEMBERSHIP_IPV4, SOCKS_IP_DROP_SOURCE_MEMBERSHIP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_DROP_SOURCE_MEMBERSHIP_NAME },
   ...
   { 83, int_val, IP_HDRINCL, SOCKS_IP_HDRINCL_LVL, SOCKS_IP_HDRINCL_IPV4, SOCKS_IP_HDRINCL_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_HDRINCL_NAME },
   { 84, int_val, IP_MULTICAST_IF, SOCKS_IP_MULTICAST_IF_LVL, SOCKS_IP_MULTICAST_IF_IPV4, SOCKS_IP_MULTICAST_IF_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_MULTICAST_IF_NAME },
   { 85, int_val, IP_MULTICAST_LOOP, SOCKS_IP_MULTICAST_LOOP_LVL, SOCKS_IP_MULTICAST_LOOP_IPV4, SOCKS_IP_MULTICAST_LOOP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_MULTICAST_LOOP_NAME },
   { 86, int_val, IP_MULTICAST_TTL, SOCKS_IP_MULTICAST_TTL_LVL, SOCKS_IP_MULTICAST_TTL_IPV4, SOCKS_IP_MULTICAST_TTL_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_MULTICAST_TTL_NAME },
   { 87, int_val, IP_OPTIONS, SOCKS_IP_OPTIONS_LVL, SOCKS_IP_OPTIONS_IPV4, SOCKS_IP_OPTIONS_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_OPTIONS_NAME },
   { 88, int_val, IP_RECVTOS, SOCKS_IP_RECVTOS_LVL, SOCKS_IP_RECVTOS_IPV4, SOCKS_IP_RECVTOS_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_RECVTOS_NAME },
   ...
   { 90, int_val, IP_RECVTTL, SOCKS_IP_RECVTTL_LVL, SOCKS_IP_RECVTTL_IPV4, SOCKS_IP_RECVTTL_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_RECVTTL_NAME },
   { 91, int_val, IP_UNBLOCK_SOURCE, SOCKS_IP_UNBLOCK_SOURCE_LVL, SOCKS_IP_UNBLOCK_SOURCE_IPV4, SOCKS_IP_UNBLOCK_SOURCE_IPV6, invalid, 0, 0, 0, 0, SOCKS_IP_UNBLOCK_SOURCE_NAME },
   { 92, int_val, IPV6_MULTICAST_HOPS, SOCKS_IPV6_MULTICAST_HOPS_LVL, SOCKS_IPV6_MULTICAST_HOPS_IPV4, SOCKS_IPV6_MULTICAST_HOPS_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_MULTICAST_HOPS_NAME },
   { 93, int_val, IPV6_MULTICAST_IF, SOCKS_IPV6_MULTICAST_IF_LVL, SOCKS_IPV6_MULTICAST_IF_IPV4, SOCKS_IPV6_MULTICAST_IF_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_MULTICAST_IF_NAME },
   { 94, int_val, IPV6_MULTICAST_LOOP, SOCKS_IPV6_MULTICAST_LOOP_LVL, SOCKS_IPV6_MULTICAST_LOOP_IPV4, SOCKS_IPV6_MULTICAST_LOOP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_MULTICAST_LOOP_NAME },
   { 95, int_val, IPV6_ADD_MEMBERSHIP, SOCKS_IPV6_ADD_MEMBERSHIP_LVL, SOCKS_IPV6_ADD_MEMBERSHIP_IPV4, SOCKS_IPV6_ADD_MEMBERSHIP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_ADD_MEMBERSHIP_NAME },
   { 96, int_val, IPV6_DROP_MEMBERSHIP, SOCKS_IPV6_DROP_MEMBERSHIP_LVL, SOCKS_IPV6_DROP_MEMBERSHIP_IPV4, SOCKS_IPV6_DROP_MEMBERSHIP_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_DROP_MEMBERSHIP_NAME },
   { 97, int_val, IPV6_RECVDSTOPTS, SOCKS_IPV6_RECVDSTOPTS_LVL, SOCKS_IPV6_RECVDSTOPTS_IPV4, SOCKS_IPV6_RECVDSTOPTS_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVDSTOPTS_NAME },
   { 98, int_val, IPV6_RECVERR, SOCKS_IPV6_RECVERR_LVL, SOCKS_IPV6_RECVERR_IPV4, SOCKS_IPV6_RECVERR_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVERR_NAME },
   { 99, int_val, IPV6_RECVHOPLIMIT, SOCKS_IPV6_RECVHOPLIMIT_LVL, SOCKS_IPV6_RECVHOPLIMIT_IPV4, SOCKS_IPV6_RECVHOPLIMIT_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVHOPLIMIT_NAME },
   { 100, int_val, IPV6_RECVHOPOPTS, SOCKS_IPV6_RECVHOPOPTS_LVL, SOCKS_IPV6_RECVHOPOPTS_IPV4, SOCKS_IPV6_RECVHOPOPTS_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVHOPOPTS_NAME },
   { 101, int_val, IPV6_RECVPATHMTU, SOCKS_IPV6_RECVPATHMTU_LVL, SOCKS_IPV6_RECVPATHMTU_IPV4, SOCKS_IPV6_RECVPATHMTU_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVPATHMTU_NAME },
   { 102, int_val, IPV6_RECVPKTINFO, SOCKS_IPV6_RECVPKTINFO_LVL, SOCKS_IPV6_RECVPKTINFO_IPV4, SOCKS_IPV6_RECVPKTINFO_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVPKTINFO_NAME },
   { 103, int_val, IPV6_RECVRTHDR, SOCKS_IPV6_RECVRTHDR_LVL, SOCKS_IPV6_RECVRTHDR_IPV4, SOCKS_IPV6_RECVRTHDR_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVRTHDR_NAME },
   { 104, int_val, IPV6_RECVTCLASS, SOCKS_IPV6_RECVTCLASS_LVL, SOCKS_IPV6_RECVTCLASS_IPV4, SOCKS_IPV6_RECVTCLASS_IPV6, invalid, 0, 0, 0, 0, SOCKS_IPV6_RECVTCLASS_NAME },
};
